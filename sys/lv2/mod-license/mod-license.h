/*
  ...
  Copyright 2016-2024 Filipe Coelho <falktx@falktx.com>
  Copyright 2018-2019 MOD Devices GmbH
  Copyright 2020-2025 MOD Audio UG
...
#define MOD_LICENSE_VERSION "v1.3.1"
