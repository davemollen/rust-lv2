...
## Building and installing the example plugins

Every example is a self-contained Rust crate; You can simply build it with cargo. If you want to install the examples on your linux machine, you can run `install_examples.sh`. This will build the crates, bundle them and copy them to `~/.lv2`.
